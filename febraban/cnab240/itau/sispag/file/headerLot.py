    ...
    def setSender(self, user):
        structs = [
            (
                ...
                1,
                numeric,
                RegistrationType.PESSOA_FISICA
                if len(user.identifier) == 11
                else RegistrationType.PESSOA_JURIDICA,
            ),  # 09.1
    ...
    def setSenderAddress(self, address):
        structs = [
            (
                ...
                50,
                alphaNumeric,
                f"{address.streetLine1} {address.streetLine2} {address.district}",
            ),

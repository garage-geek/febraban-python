from .libs.cleanData import (
    clean_data_return_only_number,
    clean_data_return_only_alphanumeric,
)
...
class UserBank:
    def __init__(
        self, bankId, branchCode, accountNumber, accountVerifier, bankName="", code=""
    ):
        self.bankId = bankId
...
class UserAddress:
    def __init__(
        self, streetLine1, city, stateCode, zipCode, district="", streetLine2=""
    ):
